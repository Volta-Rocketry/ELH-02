...
| REQ-06 | The Instrumentation Subsystem shall measure deformation of the bulkhead in at least three axis with high resolution | Functional |
...
| REQ-14 | The Instrumentation Subsystem shall operate from an independent power bus. | Electrical |
| REQ-15 | The Instrumentation Subsystem shall operate within a supply voltage range of ±10% of the nominal bus voltage. | Electrical |
...
| CON-03 | The total mass of all Instrumentation Subsystem hardware shall not exceed 1 kg. |
| CON-04 | The Instrumentation Subsystem shall operate from an internal or independent power source for a minimum duration of 4 hours. |
| CON-05 | The Instrumentation Subsystem shall fit withing the volume arranged in the avionics bay. |
